    ...
    promptAddEmployee() {
        inquirer
            ...
            },
            {
                type: 'input',
                name: 'managerID',
                message: "What is the managers employee id for this new employee? \n (If no manager, leave blank and hit return.)",
                // make this validate a number answer
                ...
                validate: verifyInput => {
                    if (verifyInput) {
                        ...
                        // verifyInput = 0
                        console.log("Please enter the id for this employee's manager.");
                        return false;
                    }
                }
            }
